...
namespace HackerRank.Week1
{
    ...
    {
        #region Problem and explanation
        /*
            Comparison Sorting
        ...
        */
        ...
        public static List<int> PerformAction(List<int> arr)
        {
            /*
             * Explanation
                Create an array with zeros uptill max number in given int array
                Then loop through original array and use its position to increament by 1 in the counting array
                Retrun the counting array
             */
